...
- **volume** - a section of a project. A single building project typically has 1 volume. A multi-building project each building will be a volume.
Mixed use buildings can also be separated into multiple volumes defined by use-type. External landscaping may be a separate volume.
...
is displaced also comply with BDNS.
:::
