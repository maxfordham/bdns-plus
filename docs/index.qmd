...
[BDNS (Building Device Naming Syntax)](https://theodi.github.io/BDNS/) ➕ **equipment tagging**. `bdns-plus` extends BDNS to define a consistent and configurable approach to producing equipment references for Design Information (drawings, schedules, specifications).
